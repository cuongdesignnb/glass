  ...
  apps: [
    {
      ...
      args: 'start -p 3222',
      cwd: '/www/wwwroot/kinhmathongnhung.vn',
      instances: 1,
      exec_mode: 'fork',
      ...
      // === Logs ===
      error_file: '/www/wwwroot/kinhmathongnhung.vn/logs/pm2-error.log',
      out_file: '/www/wwwroot/kinhmathongnhung.vn/logs/pm2-out.log',
      merge_logs: true,
