...
export default function AdminCategoriesPage() {
  ...
  const handleEdit = (cat: any) => {
    ...
    setForm({
      ...
      image: cat.image || '', icon: cat.icon || '', parent_id: cat.parent_id ? String(cat.parent_id) : '',
  ...
  return (
    <>
      <div className="admin-topbar">
        <h1 className="admin-topbar__title">Danh Mục ({allCategories.length})</h1>
      ...
      <div className="admin-content">
          ...
          <div className="admin-card" style={{ marginBottom: '24px' }}>
            ...
            <div className="admin-form">
              <div className="admin-form__row">
                <div className="admin-form__group">
                  ...
                  <input className="admin-form__input" value={form.name}
                    onChange={e => setForm({ ...form, name: e.target.value })} placeholder="Ví dụ: Kính Cận" />
                </div>
                <div className="admin-form__group">
                  ...
                  <select className="admin-form__input" value={form.parent_id}
                    ...
                    {allCategories.filter((c: any) => c.id !== editingId).map((c: any) => (
              ...
              <div className="admin-form__row" style={{ gridTemplateColumns: '1fr 1fr 1fr' }}>
                ...
                <div className="admin-form__group">
                  <label className="admin-form__label">Icon</label>
                  <button type="button" className="admin-btn admin-btn--secondary admin-btn--sm"
                    onClick={() => setShowMediaPicker('icon')}>
                    <FiImage /> Chọn Icon
                  </button>
                  {form.icon && (
                    <div style={{ marginTop: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div className="admin-card">
          <h2 className="admin-card__title" style={{ marginBottom: '16px' }}>
            <FiFolder style={{ marginRight: '8px', color: 'var(--color-gold)' }} /> Cây Danh Mục
          </h2>
          {isLoading ? (
            ...
            <p style={{ color: 'rgba(255,255,255,0.4)', padding: '24px', textAlign: 'center' }}>
              Chưa có danh mục. Click "Thêm Danh Mục" để bắt đầu.
            </p>
          ) : (
