...
export default function AdminSettingsPage() {
  ...
  const settingFields: Record<string, SettingField[]> = {
    ...
    homepage: [
      ...
      { key: 'hero_text_color', label: 'Màu chữ Hero', isColor: true, hint: 'Chọn màu chữ tiêu đề Hero. Nên chọn màu sáng nếu ảnh nền tối và ngược lại.' },
      { key: 'hero_desc_color', label: 'Màu mô tả Hero', isColor: true, hint: 'Chọn màu chữ mô tả phụ.' },
      { key: 'hero_overlay', label: 'Overlay Hero', placeholder: 'left-dark', hint: 'Kiểu overlay: left-dark, left-light, full-dark, full-light, none. Giúp text nổi bật trên ảnh nền.' },
